...
function Login() {
  return (
    <div className="w-full h-screen bg-gray-950 relative">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center shadow-2xl bg-gray-800 rounded-md p-4 text-gray-950 w-[350px] gap-4">
        <LoginForm />
        <Modal>
